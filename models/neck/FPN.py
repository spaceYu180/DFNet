...
from models.neck.evc import EVCBlock
...
class FPNNeck(nn.Module):
    def __init__(self, inplanes, neck_name='fpn+ppm+fuse'):
        ...
        self.evc3 = EVCBlock(inplanes * 4,inplanes * 4)
        self.evc2 = EVCBlock(inplanes * 2,inplanes * 2)
        self.evc1 = EVCBlock(inplanes * 1,inplanes * 1)
    ...
    def forward(self, ms_feats):
        ...
        if self.expand_field is not None:
            ...
            change3 = self.evc3(change3)
            change2 = self.evc2(change2)
            change1 = self.evc1(change1)

        # change3_2 = self.stage4_Conv_after_up(change4)
        change3_2 = self.stage4_Conv_after_up(self.up(change4))
        # print(change3.shape)
        # print(change3_2.shape)
